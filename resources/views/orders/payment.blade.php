...
<div class = "container">
    ...
    <hr>
     {!! Form::open(['action' => ['OrdersController@addPayment', $order[0]->bill_id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}      {{-- <<UPDATE IS WHERE WE ARE SUBMITTNG TO>> --}}
        ...
        <div class = "form-group">
            ...
            {{Form::text('bill_id', $order[0]->bill_id, ['class' => 'form-control', 'readonly' => 'readonly'])}}
        </div>
        
        <div class = "form-group">
            {{Form::label('grand_total', 'Grand Total')}}
            {{Form::text('grand_total', $order[0]->grand_total, ['class' => 'form-control', 'readonly' => 'readonly'])}}
        </div>
        
        <div class = "form-group">
            {{Form::label('due_amount', 'Due Amount')}}
            {{Form::text('due_amount', $bill->due_amount, ['class' => 'form-control', 'readonly' => 'readonly'])}}
        </div>

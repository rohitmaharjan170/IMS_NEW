...
@section('content')
<div class = "container">
    <a href="/orders" class='btn btn-info'><i class="nav-icon fas fa-shopping-cart"></i>&nbsp;&nbsp;Go to Sales</a>
    <a href="/clients" class='btn btn-info' style="float: right;"><i class="nav-icon fas fa-users"></i>&nbsp;&nbsp;Go to Clients</a> <br><br>

    <h1 align="center">{{$order->client_name}}'s Order Report</h1>
    <hr>
